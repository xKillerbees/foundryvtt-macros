...
SHOTS = {
    ...
    "duel-player-thrown": (
        "season-of-ghosts/who-leads-willowshore-console.js", "duel-player-thrown",
        "season-of-ghosts/who-leads-willowshore-console-player-thrown.png"),
    "campaign": (
    ...
    "campaign-act4": (
        "season-of-ghosts/campaign-status-tracker.js", "campaign-act4",
        "season-of-ghosts/campaign-status-act4.png"),
    "campaign-threads": (
