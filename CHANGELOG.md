...
- Downtime Planner: players can now ask the GM for the next downtime period. A "Request a
  ...
  asked with a one-click "Open period N". Requests live in the world setting until the GM
  opens the period, and a player can withdraw theirs. The button only appears while the next
